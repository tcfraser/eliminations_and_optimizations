...
\begin{corollary}
    ...
    \begin{equation}
        \begin{tikzcd}
            \catE / \phi \ar[drr, bend left=20, "P/\phi"] \ar[ddr, bend right, "\mathrm{cod}"] \ar[dr, dashed, "\cong", leftrightarrow] & & \\ 
...
\begin{lemma}
    A fibered category $P : \catE \to \catB$ is a faithful functor if and only if its fibers are thin.
\end{lemma}
\begin{proof}
