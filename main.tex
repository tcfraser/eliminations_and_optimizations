...
\newcommand{\pullback}[3]{
    \coordinate (tmpbeg) at ($(#1)!0.2!(#2)$);
    \coordinate (tmpend) at ($(#1)!0.2!(#3)$);
    \coordinate (tmpmid) at ($(tmpbeg) + (tmpend) - (#1)$);
    \draw[line width=2mm, white] ($(tmpbeg)!0.4!(tmpmid)$) -- (tmpmid) -- ($(tmpend)!0.4!(tmpmid)$);
    \draw ($(tmpbeg)!0.4!(tmpmid)$) -- (tmpmid) -- ($(tmpend)!0.4!(tmpmid)$);
}
...
\begin{equation}
    ...
    =
    \begin{tikzcd}[column sep=small]
    c \ar[dr, "f\circ g"'] \ar[rr, "t"] & & d \ar[dl, "f \circ h"] \\
    & b &
    \end{tikzcd}
\end{equation}
\begin{equation}
    \begin{tikzcd}[sep=large]
        c \ar[d, "g"'] \ar[dr, "f \circ h", near start] \ar[r, "t"] & d \ar[dl, "h", near end, crossing over] \ar[d, "f \circ h"] \\
        a \ar[r, "f"'] & b
    \end{tikzcd}.
\end{equation}
