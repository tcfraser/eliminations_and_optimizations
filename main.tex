...
\tcf{It turns out the subobject fibration also satisfies the Beck-Chevalley condition at all pullback squares in the base provided that image factorizations in the base are stable under (i.e. commute with) pullback; equivalently, the base is a regular category. I will finish the write up tomorrow.}
