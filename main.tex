...
\newcommand{\tob}[1]{\todo[color=blue!20,inline]{\textbf{Tobias:} #1}}
\newcommand{\tcf}[1]{\todo[color=red!20,inline]{\textbf{TC:} #1}}
...
\subsubsection{The Beck-Chevalley Condition for the Polyhedral Fibration}
